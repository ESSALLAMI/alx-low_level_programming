...
/**
*print_magic - prints the magic nums of an ELF header.
*@e_ident: A pointer to an array containing the ELF magic numbs
*Description: magic nums are separted by spaces.
*/
void print_magic(unsigned char *e_ident)
{
int index;
...
/**
*print_type - prints the type version of an ELF header.
*@e_type: The ELF type
*@e_ident: A pointer to an array containing the ELF class
*/
void print_type(unsigned int e_type, unsigned char *e_ident)
...
/**
*main - Displays the information contained ithe ELF feader.
